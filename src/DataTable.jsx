...
const DataTableComponent = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      cell: row => (
        ...
        >
          <img src="/icons/edit.png" alt="Edit" style={{ width: '16px', height: '16px' }} />
        </button>
      ),
      ignoreRowClick: true,
      $allowOverflow: true,
  ...
  const updateData = async (id, updatedData) => {
    try {
      setIsSaving(true);
      const response = await fetch(`https://67e3675c97fc65f5353981ec.mockapi.io/DataTAbleData/${id}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
                ...
                <div>
                  ...
                  <div className="modal-row">
                    ...
                    <input
                      type="date"
                      name="orderDate"
                      value={new Date(editedRow.orderDate).toISOString().split('T')[0]}
                      onChange={handleInputChange}
                      className="modal-input"
                    />
                  </div>
